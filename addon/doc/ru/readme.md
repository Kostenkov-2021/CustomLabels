...
* С помощью сочетания клавиш NVDA+Control+; (точка с запятой)
...
Кроме того, существует настройка, позволяющая использовать описание элемента управления в качестве его метки, если элемент управления не помечен. Но обратите внимание: если была установлена пользовательская метка, то она заменит описание, даже исходную метку элемента управления.
...
* Добавлена поддержка NVDA 2026.1
...
* Добавлена возможность озвучивать описание непомеченных элементов управления , что значительно улучшает доступность в приложениях на базе Java (Включить эту настройку можно по пути Настройки NVDA> Custom Labels).
* Добавлен раздел документации с описанием известных ограничений.
